...
let products = [
  ...
  new Product(12, "Manzanas Granny Smith (kg)", 300.00, 50, 0, "/assets/img-productos/"),
  new Product(13, "Naranjas (kg)", 250.00, 40, 0, "/assets/img-productos/"),
  new Product(14, "Peras Pack (kg)", 280.00, 30, 0, "/assets/img-productos/"),
  new Product(15, "Tomates (kg)", 220.00, 25, 0, "/assets/img-productos/"),
  new Product(16, "Lechuga (unidad)", 150.00, 60, 0, "/assets/img-productos/"),
  new Product(17, "Zanahorias (kg)", 200.00, 55, 0, "/assets/img-productos/"),
  new Product(18, "Papas (kg)", 270.00, 45, 0, "/assets/img-productos/"),
  new Product(19, "Cebollas (kg)", 240.00, 50, 0, "/assets/img-productos/"),
  new Product(20, "Aguacates (unidad)", 180.00, 35, 0, "/assets/img-productos/"),
  new Product(21, "Espinacas (kg)", 320.00, 20, 0, "/assets/img-productos/"),
    // Categoría Meats and Fish (id: 1)
  new Product(22, "Asado de Tira (kg)", 1600.00, 25, 1, "/assets/img-productos/"),
  new Product(23, "Bife de Chorizo (kg)", 2000.00, 20, 1, "/assets/img-productos/"),
  new Product(24, "Vacío (kg)", 1800.00, 30, 1, "/assets/img-productos/"),
  new Product(25, "Pechuga de Pollo (kg)", 1000.00, 40, 1, "/assets/img-productos/"),
  new Product(26, "Milanesa de Ternera (kg)", 1500.00, 25, 1, "/assets/img-productos/"),
  new Product(27, "Lomo de Cerdo (kg)", 1700.00, 15, 1, "/assets/img-productos/"),
  new Product(28, "Filete de Merluza (kg)", 1300.00, 30, 1, ""),
  new Product(29, "Calamares (kg)", 2200.00, 20, 1, "/assets/img-productos/"),
  new Product(30, "Chorizo (kg)", 1400.00, 25, 1, "/assets/img-productos/"),
  new Product(31, "Costillas de Cerdo (kg)", 1500.00, 20, 1, "/assets/img-productos/"),
  // Categoría Dairy and Eggs (id: 2)
  new Product(32, "Leche Entera La Serenísima 1L", 200.00, 50, 2, "/assets/img-productos/"),
  new Product(33, "Queso Cremoso La Serenísima 200g", 350.00, 30, 2, "/assets/img-productos/"),
  new Product(34, "Yogur Natural La Serenísima 1kg", 300.00, 40, 2, "/assets/img-productos/"),
  new Product(35, "Manteca La Serenísima 200g", 250.00, 25, 2, "/assets/img-productos/"),
  new Product(36, "Huevos (docena)", 400.00, 60, 2, "/assets/img-productos/"),
  // Categoría Bakery and Pastry (id: 3)
  new Product(37, "Pan de Miga (kg)", 250.00, 40, 3, "/assets/img-productos/"),
  new Product(38, "Croissants (pack de 6)", 350.00, 30, 3, "/assets/img-productos/"),
  new Product(39, "Facturas Variadas (kg)", 400.00, 25, 3, "/assets/img-productos/"),
  new Product(40, "Bizcochos (kg)", 300.00, 35, 3, "/assets/img-productos/"),
  new Product(41, "Pan Integral (kg)", 270.00, 20, 3, "/assets/img-productos/"),
  // Categoría Frozen Foods (id: 4)
  new Product(42, "Papas Fritas Congeladas (kg)", 350.00, 30, 4, "/assets/img-productos/"),
  new Product(43, "Hamburguesas Congeladas (pack de 4)", 600.00, 20, 4, "/assets/img-productos/"),
  new Product(44, "Empanadas Congeladas (pack de 12)", 500.00, 25, 4, "/assets/img-productos/"),
  new Product(45, "Pizza Congelada (unidad)", 700.00, 15, 4, "/assets/img-productos/"),
  new Product(46, "Pechugas de Pollo Congeladas (kg)", 1000.00, 20, 4, "/assets/img-productos/"),
  // Categoría Despensa (id: 5)
  new Product(47, "Arroz 1kg", 300.00, 50, 5, "/assets/img-productos/"),
  new Product(48, "Azúcar 1kg", 250.00, 45, 5, "/assets/img-productos/"),
  new Product(49, "Harina 1kg", 280.00, 55, 5, "/assets/img-productos/"),
  new Product(50, "Lentejas 1kg", 350.00, 40, 5, "/assets/img-productos/"),
  new Product(51, "Aceite de Maíz 1L", 450.00, 30, 5, "/assets/img-productos/"), 
  // Categoría Snacks and Sweets (id: 7)
  new Product(52, "Alfajor Havanna Chocolate", 500.00, 50, 7, "/assets/img-productos/"),
  new Product(53, "Galletitas Chocolinas 170g", 350.00, 60, 7, "/assets/img-productos/"),
  new Product(54, "Caramelos Sugus Pack 150g", 150.00, 70, 7, "/assets/img-productos/"),
  new Product(55, "Papas Fritas Lays 145g", 450.00, 40, 7, "/assets/img-productos/"),
  new Product(56, "Chocolates Aguila 150g", 700.00, 30, 7, "/assets/img-productos/"),
  // Categoría Cleaning Products (id: 8)
  new Product(57, "Detergente Ala Ultra 1L", 350.00, 80, 8, "/assets/img-productos/"),
  new Product(58, "Lavandina Ayudín 1L", 120.00, 100, 8, "/assets/img-productos/"),
  new Product(59, "Esponja Multiuso Scotch-Brite", 200.00, 50, 8, "/assets/img-productos/"),
  new Product(60, "Jabón en Polvo Skip 800g", 450.00, 45, 8, "/assets/img-productos/"),
  new Product(61, "Limpiador Cif Crema 500ml", 380.00, 60, 8, "/assets/img-productos/"),
  // Categoría Hygiene and Personal Care (id: 9)
  new Product(62, "Shampoo Pantene 400ml", 750.00, 40, 9, "/assets/img-productos/"),
  new Product(63, "Pasta Dental Colgate Triple Acción 90g", 150.00, 100, 9, "/assets/img-productos/"),
  new Product(64, "Desodorante Rexona Aerosol 150ml", 350.00, 70, 9, "/assets/img-productos/"),
  new Product(65, "Jabón de Tocador Dove 90g", 120.00, 90, 9, "/assets/img-productos/"),
  new Product(66, "Papel Higiénico Elite 4 Rollos", 400.00, 75, 9, "/assets/img-productos/")
];
